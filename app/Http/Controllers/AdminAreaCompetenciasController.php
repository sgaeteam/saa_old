<?php namespace App\Http\Controllers;
	...
	class AdminAreaCompetenciasController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Sigla","name"=>"sigla","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
