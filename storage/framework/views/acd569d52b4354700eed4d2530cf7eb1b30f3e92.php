...
?>           
    ...
    <?php if(file_exists($file_location)): ?>
    	...
    	<?php else: ?>
			<tr><td><?php echo e($form['label']); ?></td><td><?php echo $__env->make('crudbooster::default.type_components.'.$type.'.component_detail', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?></td></tr>		
		<?php endif; ?>
	<?php elseif(file_exists($user_location)): ?>
    	...
    	<?php else: ?>
			<tr><td><?php echo e($form['label']); ?></td><td><?php echo $__env->make('vendor.crudbooster.type_components.'.$type.'.component_detail', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?></td></tr>		
		<?php endif; ?>		
	<?php else: ?>
