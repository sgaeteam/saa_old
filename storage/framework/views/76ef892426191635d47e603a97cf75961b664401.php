...
<input type="text" placeholder="<?php echo e(trans('crudbooster.datamodal_search_and_enter')); ?>" name="q" title="<?php echo e(trans('crudbooster.datamodal_enter_to_search')); ?>" value="<?php echo e(Request::get('q')); ?>" class="form-control">
</form>

<table id='table_dashboard' class='table table-striped table-bordered table-condensed' style="margin-bottom: 0px">
<thead>	
	<?php $__currentLoopData = $coloms_alias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $col): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
...
<tbody>
	...
	<tr>	
		...
		?>
		<td><a class='btn btn-primary' href='javascript:void(0)' onclick='parent.selectAdditionalData<?php echo e($name); ?>(<?php echo json_encode($select_data_result); ?>)'><i class='fa fa-check-circle'></i> <?php echo e(trans('crudbooster.datamodal_select')); ?></a></td>
	</tr>
	<?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
</tbody>
</table>
<div align="center"><?php echo urldecode(str_replace("/?","?",$result->appends(Request::all())->render())); ?></div>