...
class CBController extends Controller {
	...
	public function getDataTable() {
		...
		if($table && $label && $foreign_key_name && $foreign_key_value) {
			$query = DB::table($table)->select('id as select_value',$label.' as select_label')->where($foreign_key_name,$foreign_key_value)->whereNull('deleted_at')->orderby($label,'asc')->get();
			return response()->json($query);
		}else{
