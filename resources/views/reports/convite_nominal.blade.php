                                          ...
                                          <tr>
                                             <td style="border-collapse: collapse;">
                                                <h2 style="font-weight: normal; margin: 0px; padding:
                                                   ...
                                                   width: 100%; color: #666;">CONVITE</span></a>
                                                </h2>
                                             </td>
                                          </tr>
                                       </tbody>
                                             ...
                                             <td style="border-collapse:
                                                ...
                                                <div style="font-family: Arial;
                                                   ...
                                                   <div style="text-align:
                                                      justify;">O Clube 2004, através de seu sócio {{$socio}},
                                                      tem a honra de convidar {{$nome}} para no dia {{$data_prevista}} frequentar nossas dependências.<br>
                                       ...
                                       <tbody>
                                          <tr>
                                             <td align="right" style="border-collapse:
                                                collapse; line-height: 0px; padding: 0;  mso-line-height-rule: exactly;">
                                                 <a href="http://www.facebook.com" target="_blank" style="display: inline-block;
                                                text-decoration: none; box-sizing: border-box;
                                                font-family: arial; width: 100%;">      
                                                &nbsp;                    
                                                <img style="height: auto; width: 30px;" dfsrc="{{asset('images/facebook.png')}}" src="{{asset('images/facebook.png')}}">               
                                                &nbsp;                             
                                                </a>
                                              </td>
                                              <td align="left" style="border-collapse:
                                                collapse; line-height: 0px; padding: 0;  mso-line-height-rule: exactly;">
                                                 <a href="http://www.facebook.com" target="_blank" style="display: inline-block;
                                                text-decoration: none; box-sizing: border-box;
                                                ...
                                                <a href="http://www.twitter.com" target="_blank" style="display: inline-block;
                                                   ...
                                                   font-family: arial; width: 100%;">      
                                                &nbsp;                    
                                                <img style="height: auto; width: 30px;" dfsrc="{{asset('images/twitter.png')}}" src="{{asset('images/twitter.png')}}">               
                                                &nbsp;                             
                                                </a>
                                             </td>
                                          </tr>
